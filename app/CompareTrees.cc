...
int main( int argc, char* argv[] )
{
  ...
  std::string root_file1 = "data/default_MC_WH_ZH_HToGG_M-125_8TeV-pythia6.root";
  std::string root_file2 = "data/razorNtuple_WH_ZH_HToGG_M-125_8TeV-pythia6.root";
  ...
  std::string tree_name1 = "ntp1";
  std::string tree_name2 = "RazorEvents";
  //std::string tree_name2 = "ntp1"; 
  std::string var_list   = "input/input_variables_diffTree.txt";
